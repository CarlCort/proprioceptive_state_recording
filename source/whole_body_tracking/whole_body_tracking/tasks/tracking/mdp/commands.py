...
class RobotCommand(CommandTerm):
    """Base command term that provides access to robot state."""

    cfg: "RobotCommandCfg"

    def __init__(self, cfg: "RobotCommandCfg", env: "ManagerBasedRLEnv"):
        super().__init__(cfg, env)

        self.robot: Articulation = env.scene[cfg.asset_name]
        self.robot_ref_body_index = self.robot.body_names.index(cfg.reference_body)
...
@configclass
class RobotCommandCfg(CommandTermCfg):
    """Configuration for :class:`RobotCommand`."""

    class_type: type = RobotCommand
...
@configclass
class MotionCommandCfg(RobotCommandCfg):
