...
class RobotStateCommand(CommandTerm):
    """Simple command term that exposes robot proprioceptive state."""

    cfg: RobotStateCommandCfg

    def __init__(self, cfg: RobotStateCommandCfg, env: ManagerBasedRLEnv):
    ...
    # ---------------------------------------------------------------------
    # Properties that expose robot state
    # ---------------------------------------------------------------------
